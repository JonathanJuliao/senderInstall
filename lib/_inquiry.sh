...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao VA Power, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar VA Power \n"
  # printf "   [1] Atualizar VA Power \n"
  printf "   [2] Deletar VA Power \n"
  printf "   [3] Bloquear VA Power \n"
  printf "   [4] Desbloquear VA Power \n"
  printf "   [5] Alter. dominio VA Power \n"
  printf "\n"
  read -p "> " option
